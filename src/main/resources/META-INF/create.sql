...
CREATE TABLE MOVIE_REVIEWS("ID" INTEGER not null primary key, "MOVIE_ID" INTEGER not null, "CUSTOMER" VARCHAR(255) not null, "RATING" INTEGER not null, "COMMENTS" VARCHAR(255))
...
ALTER TABLE MOVIE_REVIEWS ADD CONSTRAINT REVIEWS_FK FOREIGN KEY ("ID") REFERENCES MOVIES ("ID")